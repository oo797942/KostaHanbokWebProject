...
<body>
	...
	<section>
		<div id ="Goodsmenudiv">
			<a href="<%= projectName %>/1.ho?cmd=adminGoodsInsert"><input type="button" id="insert" class ="Goodsmenu" value="등록"/></a> 
			<a href="<%= projectName %>/1.ho?cmd=list-page"><input type="button" id="update" class ="Goodsmenu" value="목록 보기"/></a> 
		</div>
